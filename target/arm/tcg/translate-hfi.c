...
static TCGv_i64 read_explicit_region_reg(DisasContext *s, u_int8_t reg_num)
{
    TCGv_i64 v = tcg_temp_new_i64();
    tcg_gen_mov_i64(v, tcg_hfi.regions[reg_num + 6].reg_base);
    return v;
}
...
static bool trans_HLDR_i(DisasContext *s, arg_hldst_imm *a)
{
    ...
    do_gpr_ld_memidx(s, tcg_rt, clean_addr, mop,
                     0, memidx, iss_valid, a->rt, iss_sf, false);
    return true;
}
